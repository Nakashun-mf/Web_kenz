  ...
  if (!file) {
    return (
      <>
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-8 bg-slate-50 px-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-slate-800">検図モード</h2>
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-10 shrink-0 items-center gap-3 border-b border-slate-200 bg-white px-4">
        <span
          className="truncate text-xs font-semibold text-slate-600 max-w-[280px]"
          title={file.name}
        >
          {file.name}
        </span>
        ...
        <button
          ...
          className="rounded-lg px-2.5 py-1 text-xs font-medium text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-colors"
        >
          変更
        </button>
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-lg px-2.5 py-1 text-xs font-medium text-blue-500 hover:bg-blue-50 hover:text-blue-700 transition-colors"
        >
          比較モードへ送る
